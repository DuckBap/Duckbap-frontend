  ...
  const item = [
    {
      ...
      dDay: -1,
      achievementRate: 98,
      mainImgUrl: 'http://img.khan.co.kr/news/2019/11/29/l_2019112901003607500286631.jpg',
    },
    {
      id: 1,
      userName: '최강훈',
    ...
    },
    {
      ...
      dDay: -5,
      achievementRate: 32,
      mainImgUrl: 'http://img.khan.co.kr/news/2020/08/09/l_2020080901000887600068091.jpg',
    },
    {
      id: 5,
      userName: '최강훈',
    ...
    return (
      <Goods onClick={goToProductDetail}>
        <GoodsImgWrapper>
          <GoodsImg
            {...Hover}
            src={item.mainImgUrl || 'iu.jpeg'}
            alt={item.name || 'no alt'}
