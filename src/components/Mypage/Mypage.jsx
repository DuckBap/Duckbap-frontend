...
const Mypage = () => {
	return (
		<MyPageContainer>
			...
			<div>아이콘 제작자 <a href="https://www.flaticon.com/kr/authors/icongeek26" title="Icongeek26">Icongeek26</a> from <a href="https://www.flaticon.com/kr/" title="Flaticon">www.flaticon.com</a></div>
		</MyPageContainer>
	);
};
